...
| 模块 | 功能 | 负责人     |
|------|------|---------|
| 用户模块 | 注册/登录/JWT认证/个人资料/积分流水 | 刘源浩     |
| 板块帖子 | 板块浏览/发帖/富文本编辑/回复/楼中楼 | 乐振涛     |
| 高级管理 | 置顶/加精/管理员日志AOP/用户审核 | 刘劲翀     |
| 需求积分 | 悬赏发布/采纳/积分冻结/转账/乐观锁 | 黄康毅     |
| 公共基础 | 项目骨架/JWT/Redis/全局异常/拦截器 | 王陈鸿（组长） |
